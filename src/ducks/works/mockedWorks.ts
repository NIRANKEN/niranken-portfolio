...
export const mockedWorks: Work[] = [
  ...
  },
  {
    ...
    detail: `巷でよく使われているReactやTypescript, AWS Lambdaなどを経験でき、JavaScript生で書くよりも全然良いじゃんと思った(感想)。
  ...
  },
  {
    ...
    なので、ビルドのPipeline化をしたり、Eclipse最新にしたり、JUnit導入してサンプルのテスト書いて布教したり…。Dockerにもお世話になりました。`,
    writtenAt: 'YYYY-MM-DD',
    writtenBy: 'にらんけん',
  },
];
